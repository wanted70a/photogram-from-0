...
export const DELETE_POST_BY_ID               = 'deletePostById';
export const POST_NEW_POST                   = 'postNewPost';
...
export const UPLOAD_PROFILE_PIC              = 'uploadProfilePicture';
export const UPDATE_USER_INFO                = 'updateUserInfo';
export const LOGOUT_AUTH                     = 'logoutAuth';
