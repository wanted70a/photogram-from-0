...
export const UPDATE_CURRENT_POST_ID          = 'updateCurrentId';
export const UPDATE_CURRENT_POST             = 'updateCurrentPost';
export const UPDATE_CURRENT_COMMENT          = 'updateCurrentComment';
...
export const UPDATE_CACHED_COMMENTS          = 'updateCachedComments';
export const LOAD_MORE_COMMENTS              = 'loadMoreComments';
export const CLEAR_CACHED_COMMENTS           = 'clearCachedComments';
